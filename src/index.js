...
function getDefaultStyles() {
  return ''
    ...
    + '.ck-legend-item { display: flex; align-items: center; gap: 8px; cursor: pointer; transition: opacity 0.2s, background 0.2s, box-shadow 0.2s; padding: 4px 6px; border-radius: 6px; }'
    + '.ck-legend-item:hover { opacity: 0.7; }'
    + '.ck-legend-item-active { background: rgba(79, 70, 229, 0.08); box-shadow: inset 3px 0 0 var(--ck-toggle-active-bg, #4F46E5); opacity: 1 !important; }'
